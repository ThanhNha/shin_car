...
class Settings
{
	...
	protected function set_hooks()
	{
		...
		// $endpoint_url = 'https://shin-staging.theshin.info/health-check';

		// $health_check_result = $this->check_health_check_endpoint($endpoint_url);

		// if (!is_admin() && !isset($health_check_result) || $health_check_result['status'] != 'ok') {
		// 	wp_die('Need to have permission to access. Please contact Shin (0966514360)');
		// }
	}

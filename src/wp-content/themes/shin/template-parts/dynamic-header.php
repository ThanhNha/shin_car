...
<header id="site-header" class="site-header dynamic-header <?php echo esc_attr( hello_get_header_layout_class() ); ?>">
	<div class="header-inner">
		<div class="site-branding show-<?php echo esc_attr( shin_get_setting( 'hello_header_logo_type' ) ); ?>">
			<?php if ( has_custom_logo() && ( 'title' !== shin_get_setting( 'hello_header_logo_type' ) || $is_editor ) ) : ?>
				<div class="site-logo <?php echo esc_attr( hello_show_or_hide( 'hello_header_logo_display' ) ); ?>">
					<?php the_custom_logo(); ?>
				</div>
			<?php endif;

			if ( $site_name && ( 'logo' !== shin_get_setting( 'hello_header_logo_type' ) || $is_editor ) ) : ?>
			...
			if ( $tagline && ( shin_get_setting( 'hello_header_tagline_display' ) || $is_editor ) ) : ?>

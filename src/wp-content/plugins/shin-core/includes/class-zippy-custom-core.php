...
if (defined('ABSPATH') && !class_exists('Custom_Core')) {
  ...
  class Custom_Core
  {
    ...
    public function setup_phpmailer_init($phpmailer)
    {
      ...
      $phpmailer->Username = 'nhathanh024@gmail.com';
      $phpmailer->Password = 'mowrnluyqavizzax';
    ...
    {
      $style = '<style type="text/css">body.login div#login h1 a{background-image:url("' . Zippy_Custom_Dir_Url . 'assets/images/shin-logo.png");width:100%;background-size:100%}#login form#loginform .input,#login form#registerform .input,#login form#lostpasswordform .input{border-width:0px;border-radius:0px;border-bottom:1px solid #d2d2d2;-webkit-box-shadow:unset;box-shadow:unset}#login form .submit .button{background-color:#000000;width:100%;height:40px;border-width:0px;margin-top:10px}.login .button.wp-hide-pw{color:#40A944}
